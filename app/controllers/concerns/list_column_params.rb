...
# meaning — a player's positions read most-played first, and a season's roster
# slots are a list that repeats ("rb", "rb", "wr"...). Neither survives a set of
# checkboxes, so the admin forms edit them as a single comma-separated text box
# and hand the splitting back here.

...
counts toward no playoff streak or drought, and the league table's tier column shows that season's
tiers rather than next year's ladder (`tier_column_year`/`tier_column_for`). Value
